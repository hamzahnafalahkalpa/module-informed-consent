...
use Hanafalah\ModuleInformedConsent\Resources\ViewInformedConsent;
...
class InformedConsent extends BaseModel
{
    ...
    public function masterConsent()
    {
        return $this->belongsToModel("MasterInformedConsent", 'master_consent_id', "id");
    }
}
